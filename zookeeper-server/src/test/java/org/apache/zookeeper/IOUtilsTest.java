    ...
    public static class CopyBytes2Test {
        ...
        public void copyBytes2Test() {
            ...
            try {
                ...
                File file = new File("leopetr95/zookeeper/zookeeper-server/src/main/resources/inPutFile.txt");
                BufferedReader bufferedReader = new BufferedReader(new FileReader(file));
                String strInput = bufferedReader.readLine();
                System.out.println(strInput);
                ...
                File file1 = new File("leopetr95/zookeeper/zookeeper-server/src/main/resources/outPutFile.txt");
                BufferedReader bufferedReader1 = new BufferedReader(new FileReader(file1));
                String strOutput = bufferedReader1.readLine();
                System.out.println(strOutput);
